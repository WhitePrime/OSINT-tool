...
####  [ Пароли, адреса электронной почты, номера телефонов ](#passwordsemailsphonenumbers)
...
### Поисковики, скреперы, экстракторы, парсеры
### Поиск перенаправления
### Анализ cookie-файлов
### Анализ метаданных файлов сайта и файлов загрузки
### Анализ обратных ссылок
### Анализ веб-сайта
### Исследование домена/IP
### Сканирование/брутфорс субдоменов
### Cloudfare
### Базы данных доменов
...
[Fire MAP NASA](https://firms.modaps.eosdis.nasa.gov/map/)  - онлайн-карта очагов пожаров по всему миру (данные со спутников VIIRS и MODIS за последние сутки)  
...
[Crimemapping.com](https://www.crimemapping.com/)  - выберите государство, полицейское учреждение, а также какие преступления и где были совершены на территории, находящейся под его контролем, за последние 24 часа, неделю или месяц.  
...
[Vincos.it](http://vincos.it/world-map-of-social-networks)  - карта популярности в социальных сетях  
...
[Twish](https://chrome.google.com/webstore/detail/twish/afpegchfbaddfmenhkajjggbnjfjejeh/related)  - очень простой, быстрый, удобный и красиво оформленный расширенный конструктор поисковых запросов #Twitter для #GoogleChrome.  
...
[Tiktok Scraper](https://github.com/sauermar/Tiktok-Scraper)  - Извлекайте данные о видео, пользователях и каналах на основе хэштегов, профилей и отдельных сообщений.  
...
[steamdb.info/calculator](https://steamdb.info/calculator/)  - показывает, сколько денег было потрачено на игры в Steam конкретным пользователем
...
[Redditsave.com](https://redditsave.com)  - Загрузчик видео с Reddit  
[DownGit](https://minhaskamal.github.io/DownGit/#/home)  - Создать ссылку для скачивания ресурсов GitHub  
[SaveFrom.net](https://en.savefrom.net/70/)  - скачать видео с YouTube, Vimeo, ВК, Одноклассников и десятков других сервисов
...
[Goblyn](https://github.com/loseys/Goblyn)  - инструмент, ориентированный на перечисление и сбор метаданных файлов веб-сайта. Он будет искать активные каталоги на веб-сайте и, таким образом, перечислять файлы, если он найдет какой-либо файл, он получит метаданные файла.  
...
[Ditto](https://github.com/evilsocket/ditto)  - Инструмент Dsmall, который принимает на вход доменное имя и генерирует на выходе все его варианты для омографической атаки, проверяя, какие из них доступны, а какие уже зарегистрированы.  
...
[HypeStat Analyzer Plugin](https://chrome.google.com/webstore/detail/hypestat-analyzer-plugin/fmebbkhpaallipfibkfnajnlimgaoefp/related)  - Показывает приблизительный ежедневный трафик веб-сайта, рейтинг Alexa, среднюю продолжительность посещения и используемые технологии.  
...
[EXIF-PY](https://github.com/ianare/exif-py)  - получить exif данные фотографий через командную строку  
...
[Watools.io](https://watools.io/download-profile-picture)  - скачать фото профиля ватсап  
...
[Find Who Events](https://cse.google.com/cse?cx=017922636351918147428:v7m0tfgk6uj#gsc.tab=0)  - Google CSE для поиска событий по местоположению (ключевым словам) в #Facebook, #Eventbrite, #Xing, #Meetup, #Groupon, #Ticketmaster, #Yepl, #VK, #Eventective, #Nextdoor  
...
[2lingual.com](https://2lingual.com/)  - гугл поиск на двух языках одновременно в одном окне  
...
[@maigret\_osint\_bot](https://t.me/maigret_osint_bot)  - проверять аккаунты по имени пользователя на 1500 сайтах. На основе инструмента CLI Мегрэ  
...
[SovaWeb](http://sovaweb.herokuapp.com/)  - веб-версия известного российского бота в Telegram для поиска по электронной почте, нику, IMSI, IMEI, MSISDN, BTS, IP, BSSID  
[Profil3r](https://github.com/Rog3rSm1th/Profil3r)  - поиск профилей в социальных сетях по нику  
[Aliens eye](https://github.com/BLINKING-IDIOT/Aliens_eye)  - Найдите ссылки на учетные записи социальных сетей на 70 веб-сайтах по имени пользователя.  
[Thorndyke](https://github.com/rlyonheart/thorndyke)  - Проверяет доступность указанного имени пользователя на более чем 200 веб-сайтах.  
[Marple](https://github.com/soxoj/marple)  - Он собирает ссылки, содержащие псевдоним/имя/фамилию в URL-адресе из результатов поиска Google и DuckDuckGo.  
[BehindTheNames](https://www.behindthename.com)  - при проведении углубленного поиска информации о человеке важно проверять различное произношение его имени и уменьшительно-ласкательных. Этот сервис поможет вам их найти  
[Holehe](https://github.com/megadose/holehe)  - проверить, используется ли почта на разных сайтах, таких как твиттер, инстаграм, и получить информацию на сайтах с функцией забытого пароля  
[H8mail](https://github.com/khast3x/h8mail)  - отправляйте OSINT по электронной почте и инструмент для поиска нарушений, используя различные службы взлома и разведки, или локальные нарушения, такие как «Collection1» Троя Ханта и печально известный торрент «Breach Compilation».  
[Psbdmp.ws](https://psbdmp.ws)  - искать конфиденциальные пользовательские данные по 25 759 511 pastebins  
[MailBoxLayer API](https://mailboxlayer.com/)  - бесплатный API для проверки адреса электронной почты  
[EmailHippo](https://tools.emailhippo.com/email/)  - Простой бесплатный онлайн-инструмент для проверки существования того или иного адреса электронной почты и оценки его надежности по 10-балльной шкале.  
[Numverify API](https://numverify.com/)  - бесплатный API для поиска и проверки глобального номера телефона  
[Cybernews RockYour2021](https://cybernews.com/personal-data-leak-check/)  - проверьте, не утекли ли ваши данные  
[Spycloud.com](https://spycloud.com/check-your-exposure/)  - проверить наличие определенного электронного письма в утечках данных. Показывает, сколько адресов, зарегистрированных в конкретном доме, было зашифровано  
[Gravatar check](https://en.gravatar.com/site/check/)  - Просто введите адрес электронной почты и посмотрите, как выглядит аватар человека в Gravatar.  
[UserFinder](https://github.com/mishakorzik/UserFinder)  - инструмент для поиска профилей по имени пользователя  
[Many Passwords](https://many-passwords.github.io/)  - Пароли по умолчанию для IoT-устройств и веб-приложений (например, панели администратора MySQL и PostgreSQL)  
[PassHunt](https://github.com/Viralmaniar/Passhunt)  - Инструмент командной строки для поиска учетных данных по умолчанию для сетевых устройств, веб-приложений и многого другого. Поиск среди 523 поставщиков и их 2084 паролей по умолчанию  
[BugMenot](http://bugmenot.com)  - логины и пароли для публичных аккаунтов в разных сервисах  
[FireFly](https://github.com/Lexxrt/FireFly)  - Получить информацию о номере телефона с помощью Numverify API
[GoFindWho People Search](https://gofindwho.com/)  - Более 300 инструментов для сбора информации о людях в одном. Поиск по имени, имени пользователя, телефону, адресу, названию компании.  
[Anywho](https://anywho.com/)  - Поиск людей в #США. Введите имя и фамилию, чтобы получить возраст, адрес и часть номера телефона (бесплатно)  
[Usersearch.org](https://usersearch.org/index.php)  - поиск людей по нику, телефону или электронной почте  
[Ellis Island](http://heritage.statueofliberty.org)  - онлайн-база данных с возможностью поиска по 65 миллионам прибытий в #NewYork между (конец 19-го и начало 20-го века).  
[recordsearch.naa.gov.au](https://recordsearch.naa.gov.au/SearchNRetrieve/Interface/SearchScreens/PassengerSearch.aspx)  - Национальный архив #Австралия  
[SpyDialer](https://www.spydialer.com/)  - Бесплатный поиск контактной информации по номеру телефона, имени, адресу или электронной почте  
[Scamdigger.com](http://scamdigger.com/)  - поиск в базе #мошенников по имени, IP-адресу, электронной почте или телефону  
[](https://github.com/snooppr/snoop)	Поиск профиля пользователя по нику  
[Pyosint](https://github.com/d8rkmind/Pyosint)  - Поиск по именам пользователей формирует список из 326 веб-сайтов. Удалите веб-сайт, чтобы извлечь все ссылки с данного веб-сайта. Автоматизируйте поиск поддоменов данного домена из разных сервисов  
[Cloob.com](https://www.cloob.com/profile/search/index)  - Иранцы ищут  
[SlaveVoyages.org](https://slavevoyages.org/resources/names-database)  - Базы данных трансатлантической и внутриамериканской работорговли являются кульминацией нескольких десятилетий независимых и совместных исследований ученых, опирающихся на данные библиотек и архивов по всему атлантическому миру.  
[Alternate Spelling Finder](https://datayze.com/alternate-spelling-finder)  - При поиске информации по имени помните, что одно и то же имя может записываться в документах и ​​делах очень по-разному, так как люди разных национальностей по-разному воспринимают звуки.  
[Translit.net](https://translit.net)  - Иногда бывает, что имя человека написано кириллицей, но в гугле можно найти много информации о нем, если набрать его транслитерацию «Иван Иванов». Этот инструмент пригодится при работе с русскими, белорусскими, украинскими, армянскими именами.  
[NAMINT](https://seintpl.github.io/NAMINT/)  - Введите имя, отчество (или псевдоним) и фамилию, а затем нажмите Go! чтобы увидеть возможные шаблоны поиска и ссылки (Google, Яндекс, Facebook, Twitter, Linkedin и другие социальные сети)
[Face Generator](https://generated.photos/face-generator/)  - Генератор лиц для создания #sockpuppets. Настройте пол, возраст, положение головы, эмоции, цвет волос и кожи, макияж и очки.  
[VoiceBooking](https://www.voicebooking.com/en/free-voice-over-generator)  - поддельный голосовой генератор  
[ThisXDoesNotExist](https://thisxdoesnotexist.com)  - коллекция из более чем 30 сервисов, генерирующих различные предметы с помощью нейросетей.  
[TheXifer](https://www.thexifer.net)  - добавить поддельные метаданные к фотографии  
[GeoTagOnline](https://geotagonline.com)  - добавить поддельные геотеги к фотографии  
[Fake ID Identity Random Name Generator](https://www.elfqrin.com/fakeid.php)  - сгенерируйте случайного персонажа с поддельным именем для игр, романов или аватаров вашего альтер-эго. Мгновенно создавайте новое виртуальное одноразовое удостоверение.  
[@TempMail\_org\_bot](https://t.me/TempMail_org_bot)  - телеграмм бот для быстрого создания временных адресов электронной почты (для получения писем при регистрации на разных сайтах)  
[Text2img](https://deepai.org/machine-learning-model/text2img)  - генератор текста в изображение AI  
[Face Anonimyzer](https://generated.photos/anonymizer)  - Загрузите фотографию лица и получите набор похожих лиц, сгенерированных ИИ.  
[AI video generator](https://www.synthesia.io/free-ai-video-demo)  - Введите текст (сценарий видео). Выберите персонажа и шаблон сценария. Нажмите кнопку «Отправить видео». Введите свои регистрационные данные и дождитесь письма с результатом  
[AI Face maker](https://massless.io/tool/face-maker-ai/)  - Просто нарисуйте лицо человека (обратите внимание, что для каждой части лица есть отдельный инструмент), и нейросеть сгенерирует на его основе реалистичную фотографию.  
[SessionBox](https://chrome.google.com/webstore/detail/sessionbox-multi-login-to/megbklhjamjbcafknkgmokldgolkdfig?hl=ru)  - расширение для браузера с несколькими входами  
[MultiLogin](https://chrome.google.com/webstore/detail/multilogin/ijfgglilaeakmoilplpcjcgjaoleopfi?hl=ru)  - расширение для браузера с несколькими входами  
[FreshStart](https://chrome.google.com/webstore/detail/freshstart-cross-browser/nmidkjogcjnnlfimjcedenagjfacpobb?hl=ru)  - расширение для браузера с несколькими входами
[Wordtune.com](https://wordtune.com/read)  - Укажите ссылку на текст статьи или загрузите PDF-документ. В ответ сервис выдаст краткий пересказ основной мысли текста.  
[Manytools](https://manytools.org)  - Коллекция инструментов для автоматизации повторяющихся задач, связанных с веб-разработкой и взломом.  
[Gdown](https://github.com/wkentaro/gdown)  - При загрузке файлов с Google Диска curl/wget не работает (из-за предупреждения о безопасности). Но эта проблема легко решается.  
[Webdext](https://chrome.google.com/webstore/detail/webdext/jkgddhdaaejpmlmddpbedgnkdgiacblk/related)  - Интеллектуальный и быстрый экстрактор веб-данных для #GoogleChrome. Поддержка извлечения данных с веб-страниц, содержащих список объектов, таких как список продуктов, список новостей, результаты поиска и т. д.  
[Online Loudness Meter](https://youlean.co/online-loudness-meter/)  - позволяет оценить громкость шумов в помещении или проанализировать громкость звуков в файле записи.  
[Download Sorter](https://chrome.google.com/webstore/detail/download-sorter/mebfblkahpknogabckmdjcmjbnpfdpcj/related)  - простой инструмент, который поможет за минуту настроить раздачу файлов с разными расширениями по разным папкам и навсегда привести в порядок папку «Загрузки».  
[Z History Dump](https://chrome.google.com/webstore/detail/z-history-dump/ahpkicobhkchblogldpjchdhmdnblpkm/related)  - Откройте chrome://history/ и скачайте все ссылки из истории браузера в json. Это дает огромные возможности для визуализации и анализа информации.  
[Codesandbox](https://codesandbox.io/)  - Отличная онлайн-среда для создания, тестирования и исследования написанных инструментов JavaScript (а в #OSINT их много: social-analyzer, opencti, rengin, aleph).  
[Voice Stress Test](https://www.cignaglobal.com/stress-care/individuals/voice-tool)  - Инструмент анализирует голос и определяет уровень стресса человека.  
[Scrapersnbots](https://www.scrapersnbots.com/webtools/)  - Сборник самых разнообразных онлайн-инструментов для #osint и не только: поиск пользователей с определенным именем на разных сайтах, поиск картинок по одному домену #Google, просмотр тегов YouTube, извлечение url и многое другое  
[Broken Link Hijacker](https://github.com/MayankPandey01/BrokenLinkHijacker)  - Сканирует веб-сайт и ищет все неработающие ссылки (в «[ Headlines.Sharethrough.com ](https://headlines.sharethrough.com/)
[Miteru](https://github.com/ninoseki/miteru)  - Экспериментальный инструмент обнаружения фишинговых наборов. Он собирает фишинговые URL-адреса из фишинговых информационных каналов и проверяет каждый фишинговый URL-адрес, включает ли он список каталогов и содержит ли он набор для фишинга (сжатый файл) или нет.  
[Slideshare Downloader](https://github.com/mohan3d/slideshare-go)  - Очень простой и быстрый инструмент для скачивания презентаций Slideshare в формате PDF (рекомендуем сразу выбрать Высокое качество)  
[Web history stat](https://chrome.google.com/webstore/detail/web-history-stat/fccaimiahhpljpnlnheimldcfhdhjgdl/related)  - подробная статистика истории вашего браузера  
[@YTranslateBot](https://t.me/YTranslateBot)  - введите текст или повторно отправьте сообщение боту Telegram для его перевода.  
[Google Docs to Markdown online converter](https://mr0grog.github.io/google-docs-to-markdown/)  - просто скопируйте текст на сайт  
[CloudHQ](https://www.cloudhq.net/apps)  - Сборник из нескольких десятков расширений для #Chrome, позволяющих расширить функциональность стандартного интерфейса #Gmail и максимально увеличить вашу #продуктивность. Отслеживание, сортировка, совместное использование, сохранение, редактирование и многое другое.  
[AHA Music](https://chrome.google.com/webstore/detail/aha-music-song-finder-for/dpacanjfikmhoddligfbehkpomnbgblf/related)  - Очень простой инструмент, помогающий определить, какой трек воспроизводится в текущей вкладке браузера. Что мне больше всего в нем нравится, так это то, что он работает при выключенном звуке (хотя и с небольшой задержкой).  
[Talend API Tester Free Edition](https://chrome.google.com/webstore/detail/talend-api-tester-free-ed/aejoelaoggembcahagimdiliamlcdmfm/related?hl=ru)  - инструмент, позволяющий быстро тестировать запросы к различным API прямо в браузере, отправлять запросы и проверять ответы, проверять поведение API  
[Web--proxy](https://web--proxy.herokuapp.com/)  - бесплатный веб-прокси  
[RemindWhen](http://www.remindmewhen.io/)  - Простое приложение, которое напоминает вам по электронной почте, если ваша любимая страна открывается для туристов из вашей страны.  
[Broken Link Checker](https://chrome.google.com/webstore/detail/broken-link-checker/nibppfobembgfmejpjaaeocbogeonhch/related)  - показывает, какие ссылки на странице выдают ошибки. Это помогает найти сайты, которые недавно работали, но уже не работают.  
[Binvis](https://binvis.io/)  - позволяет визуально разбирать и анализировать двоичные файлы. Это интерактивный внук онлайн-инструмента статической визуализации.  
[Gdrive-copy](https://script.google.com/macros/s/AKfycbxbGNGajrxv-HbX2sVY2OTu7yj9VvxlOMOeQblZFuq7rYm7uyo/exec)  - Стандартный функционал #GoogleDrive не позволяет скопировать папку целиком со всеми вложенными папками и файлами. Но это можно сделать с помощью сторонних приложений  
[unscreen.com](https://www.unscreen.com/)  - удалить фон из загруженного видео  
[shellcheck.net](https://www.shellcheck.net/)  - анализирует скрипты командной строки и подробно объясняет обнаруженные в них ошибки  
[Archivebox](https://archivebox.io)  - Создайте свой собственный автономный веб-архив. Сохраняйте страницы из истории браузера, закладок, Pocket и т.д. Сохраняйте html, js, css, media, pdf и другие файлы  
[Udemy Video Playback Speed](https://chrome.google.com/webstore/detail/udemy-video-playback-spee/jipobffkabkgddgmdmmgjoaopbnjnffn/related)  - Простое расширение, изменяющее скорость воспроизведения видеокурсов на #Udemy.  
[Magical. Text Expander](https://chrome.google.com/webstore/detail/magical-text-expander/iibninhmiggehlcdolcilmhacighjamp/related)  - Создавайте ярлыки в Google Chrome, чтобы сократить время ввода текста. Например: шаблоны писем, шаблоны сообщений для мессенджеров, подписи и контактная информация, имена людей со сложным написанием (lom -> Lomarrikkendd)  
[coveryourtracks.eff.org](https://coveryourtracks.eff.org)  - может многое рассказать о вашем браузере и компьютере, в том числе показать список установленных в системе шрифтов.  
[Gephi](https://github.com/gephi/gephi)  - быстрый и простой в освоении инструмент графовой аналитики с большим количеством модулей (плагинов)  
[Regular Expression Analyzer](https://xenon.stanford.edu/~xusch/regexp/)  - супер инструмент для тех, кто забывает оставлять комментарии к своему коду или вынужден иметь дело с чужим кодом.  
[Search Commands](https://chrome.google.com/webstore/detail/search-commands/ggjakfijchdkbmmhbfemjciidhnipgoe/related)  - Расширение Google Chrome предоставляет инструмент команд в стиле швейцарского ножа внутри адресной строки вашего браузера, чтобы улучшить ваш поиск.  
[Smart ruler](https://chrome.google.com/webstore/detail/smart-ruler/npgpdlfoflcfcohplcdclmocfemgpdga/related)  - Простое расширение #GoogleChrome (200 000 пользователей) для любителей исследовать дизайн разных сайтов  
[Developer search tool](https://chrome.google.com/webstore/detail/developer-search-tool/bkolnanfonknnhpeakommihhllojnecf/related)  - Поднимите искусство копирования и вставки из Stack Overflow на новый уровень скорости и продуктивности.  
[Online tools](https://emn178.github.io/online-tools/index.html)  - 55 инструментов для вычисления хеш-функций, вычисления контрольной суммы файла, кодирования и декодирования строк  
[HTTP Cat](https://github.com/httpcats/http.cat)  - бесплатный #API для получения изображений с кошками для разных кодов ответа HTTP  
[Gitpod.io](https://gitpod.io/workspaces)  - запускать код из репозиториев на Github прямо в браузере  
[CrackStation.net](https://crackstation.net/)  - взломщик паролей  
[Siftrss.com](https://siftrss.com/)  - инструмент для фильтрации RSS-каналов  
[HTTPIE.IO](https://httpie.io/run)  - HTTP-клиент командной строки  
[Tobloef.com](https://tobloef.com/text2mindmap/)  - текст для ментальной карты  
[CyberChef](https://gchq.github.io/CyberChef/)  - коллекция из более сотни онлайн-инструментов для автоматизации самых разных задач (кодирование строк, сравнение текстов, удаление двойных пробелов)  
[Textise.net](https://www.textise.net/)  - преобразовать HTML-код страницы в TXT  
[Shadowcrypt Tools](https://shadowcrypt.net/tools/)  - 24 онлайн-инструмента для OSINT, сканирования сети, шифрования MD5 и многих других  
[Google Docs Voice Comments](https://chrome.google.com/webstore/detail/record-voice-comments-in/lbfofpndjldbnhnhibhmggblcbpoomon)  - простой трюк для экономии времени. Голосовые комментарии в GoogleDocs, Sheets, Slides и Forms.  
[Text to ASCII Art Generator (TAAG)](http://patorjk.com/software/taag/#p=display&f=Graffiti&t=Type%20Something%20)  - Этот сайт поможет вам сделать атмосферные надписи для вашего инструмента командной строки или README.  
[Cheat sheet maker](http://cheatsheet-maker.herokuapp.com)  - простой инструмент для создания шпаргалок  
[Caloriemama](https://www.caloriemama.ai/api)  - ИИ может определить тип еды по фотографии и дать информацию о ее калорийности.  
[Webmapper](https://chrome.google.com/webstore/detail/webmapper/foachceonkmkeiigdbkjcihnaabppicf/related)  - Расширение, которое создает визуализацию карты на основе истории браузера. Визуальное представление самых посещаемых сайтов за 10, 20, 50 или 100 дней. Масштабируемость и поиск.
[Osint Search Tools](http://git.hopain.cyou/OSINT-Search-Tools/)  - Несколько сотен ссылок для быстрого поиска в Социальных сетях, Сообществах, Картах, Поисковиках документов, Картах, Вставках...  
[Scrummage](https://github.com/matamorphosis/Scrummage)  - Ultimate OSINT и Threat Hunting Framework  
[Mr.Holmes](https://github.com/Lucksi/Mr.Holmes)  - инструментарий osint для сбора информации о доменах, телефонных номерах и учетных записях в социальных сетях  
[SEMID osint framework](https://github.com/Himatric/SEMID)  - Поиск информации о пользователе в Tiktok, Playstation, Discord, Doxbin, Twitter, Github  
](https://github.com/C0MPL3XDEV/E4GL30S1NT)[NAZAR](https://github.com/MR-NULL666/NAZAR)  - универсальный Osint Toolkit E4GL30S1NT
[Recon Spider](https://github.com/bhavsec/reconspider)  - Advanced Open Source Intelligence (#OSINT) Framework для сканирования IP-адресов, электронных писем, веб-сайтов, организаций  
[Hunt Osint Framework](https://nitinpandey.in/ihunt/)  - Десятки онлайн-инструментов для разных этапов расследований #osint  
[GoMapEnum](https://github.com/nodauf/GoMapEnum)  - Сбор писем в Linkedin (через Linkedin и через Google) + Перечисление пользователей и перебор паролей в Azure, ADFS, OWA, O365 (эта часть, похоже, еще в разработке)  
[FoxyRecon](https://addons.mozilla.org/ru/firefox/addon/foxyrecon/)  - 44 инструмента osint в одном дополнении для #Firefox  
[Owasp Maryam](https://github.com/saeeddhqan/Maryam)  - модульная структура с открытым исходным кодом, основанная на OSINT и сборе данных  
[Metabigoor](https://github.com/j3ssie/metabigor)  - Простой и быстрый фреймворк #osint  
[Geekflare Tools](https://gf.dev/toolbox)  - 39 бесплатных онлайн-инструментов для тестирования веб-сайтов  
[Oryon OSINT query tool](https://docs.google.com/spreadsheets/d/1_x3PXGOahhKT3-ePaWhb3hM1dVxjmBvsVlw6D6lilTQ/edit#gid=1116439221)  - Создавайте ссылки на исследования в Google Sheet  
[Discover](https://github.com/leebaird/discover)  - Пользовательские сценарии bash, используемые для автоматизации различных задач тестирования на проникновение, включая разведку, сканирование, синтаксический анализ и прослушивание с помощью metasploit (16 инструментов в одном)  
[one-plus.github.io/DocumentSearch](https://one-plus.github.io/DocumentSearch)  - Набор инструментов для поиска документов  
[Profounder](https://github.com/d8rkmind/Profounder)  - поиск пользователей по нику и удаление URL-адресов с веб-сайта  
[Ashok](https://github.com/ankitdobhal/Ashok)  - Swiff нож для #osint  
[IVRE](https://github.com/ivre/ivre)  - фреймворк для сетевой разведки  
[SEARCH Investigative and Forensic Toolbar](https://chrome.google.com/webstore/detail/search-investigative-and/idgjbdfnngdcenpahfalcamfmcjdfbcj/related)  - расширение с быстрым доступом к десяткам онлайн-инструментов для разведки, криминалистики и других целей расследования.  
[Tenssens](https://github.com/thenurhabib/tenssens)  - осинт-фреймворк
[Grep for OSINT](https://github.com/cipher387/grep_for_osint)  - простой инструментарий, помогающий быстро извлечь «важные данные» (номера телефонов, адреса электронной почты, URL-адреса) из текстовой/файловой директории  
[Diffnow.com](http://diffnow.com)  - Сравнивает и находит различия в тексте, URL (html-код, скачанный по ссылке), офисных документах (doc, docx, xls, xlsx, ppt, pptx), исходном коде (C, C++, C#, Java, Perl, PHP и др.), архивы (RAR, 7-zip и т.д.).  
[Dicom Viewer](https://www.imaios.com/en/Imaios-Dicom-Viewer)  - просмотреть фото МРТ или КТ онлайн (файлы .DCM)  
[CompressedCrack](https://github.com/mnismt/CompressedCrack)  - Простой инструмент для подбора паролей к архивам ZIP и RAR  
[Encrytped ZIP file creator](https://www.protectedzip.com/)  - Создать ZIP-архив онлайн  
[PDFX](https://github.com/metachris/pdfx)  - получить метаданные файлов PDF через командную строку  
[@mediainforobot](https://t.me/mediainforobot)  - Telegram-бот для получения метаданных из разных типов файлов  
[Mutagen](https://github.com/quodlibet/mutagen)  - получить метаданные аудиофайлов через командную строку  
[compress-or-die.com/analyze](https://compress-or-die.com/analyze)  - получить подробную информацию об изображениях (exif, метатеги, ICC \_ Profile, таблицы квантования)  
[aperisolve.fr](https://aperisolve.fr)  - Инструмент анализа глубоких слоев изображения (Supperimposed, Red, Green, Blue) и свойств (Zsteg, Steghide, Outguess, Exif, Binwalk, Foremost).  
[voyant-tools.org](https://voyant-tools.org/)  - анализ отдельных слов в файлах .TXT, .DOCX, .XLSX, .CSV и других типах файлов.  
[RecoveryToolBox](https://recoverytoolbox.com/)  - инструменты для восстановления поврежденных файлов Excel, CorelDraw, Photoshop, PowerPoint, RAR, ZIP, PDF и других файлов
[Nonfungible.com](https://nonfungible.com)  - помочь проанализировать рынок NFT, узнать, какие токены продавались наиболее активно (неделя, месяц, год, за все время)
[Wordstat.yandex.ru](https://wordstat.yandex.ru/)  - предполагаемое количество поисковых запросов Яндекса в ближайший месяц по разным ключевым словам  
[Keywordtool.io](https://keywordtool.io/search/keywords/)  - сопоставление ключевых слов для Google, YouTube, Amazon, Ebay, Bing, Instagram, Twitter  
[Google Play Scraper](https://github.com/facundoolano/google-play-scraper)  - получить самую подробную  
[App Store Scraper](https://github.com/facundoolano/app-store-scraper)  - получить самые подробные метаданные о приложении из AppStore
[openownership.org](http://openownership.org)  - Данные о бенефициарной собственности по всему миру.  
[opensanctions.org](https://opensanctions.org)  - Открытые данные о попавших под санкции людях и компаниях в разных странах из 35 (!) разных источников.  
[Lei.bloomberg.com](https://lei.bloomberg.com/search?.=1&.=-lastUpdateDate&.=&.=&.=%5B%5D&ts=2447821118)  - поиск информации о компании по юридическому идентификационному номеру  
[FDIC search](https://banks.data.fdic.gov/bankfind-suite/bankfind)  - Поиск банков по номеру сертификата FDIC (Федеральная корпорация страхования депозитов) и получение подробной информации о нем  
[990 finder](https://candid.org/research-and-verify-nonprofits/990-finder)  - Введите название компании и выберите штат, чтобы получить ссылку для загрузки формы 900.  
[Iban.com](https://www.iban.com/iban-checker)  - Проверьте действительность IBAN (международный номер банковского счета) компании и посмотрите информацию о банке, в котором она обслуживается  
[Related List](http://relateoak2hkvdty6ldp7x67hys7pzaeax3hwhidbqkjzva3223jpxqd.onion.pet/)  - найти связанные с компанией контакты и конфиденциальные документы, просочившиеся в сеть  
[Open Corporates Command Line Client (Occli)](https://github.com/rlyonheart/occli)  - Сбор подробной информации о компании через cli.  
[NewsBrief](https://emm.newsbrief.eu/NewsBrief/clusteredition/ru/latest.html)  - Ищем недавние упоминания компании в интернет-СМИ по всему миру.  
[Investing.com](https://www.investing.com/)  - Посмотреть подробный инвестиционный профиль компании  
[FCCID.IO](https://fccid.io)  - поиск по идентификатору FCC, стране, дате, названию компании или частоте (в МГц)  
[Freebin Checker](https://api.freebinchecker.com/bin/658205)  - удобный API для получения банковских реквизитов по БИН. Более 850 000 записей BIN в базе данных FreeBinChecker  
[Tradeint](https://tradint.io/tradint-researcher/)  - Быстрый доступ к более чем 85 инструментам для сбора информации о компании и веб-сайте компании, местоположении и отрасли.  
[Corporative Registry Catalog](https://cipher387.github.io/corporative_registry_worldwide_catalog/)  - всемирный каталог коммерческих реестров (63 страны)  
[WIPO.int](https://www3.wipo.int/branddb/en/)  - Глобальная база данных брендов (46 020 000 записей)  
[TMDN Design View](https://www.tmdn.org/tmdsview-web/)  - Поиск 17 684 046 дизайнов продуктов в Европейском Союзе и за его пределами  
[TESS](https://tmsearch.uspto.gov/bin/gate.exe?f=login&p_lang=english&p_d=trmk)  - Поисковая система для товарных знаков #США  
[TendersInfo](https://www.tendersinfo.com)  - Поиск тендеров по всему миру по ключевым словам.
[Amazon Scraper](https://github.com/scrapehero-code/amazon-scraper)  - вычищена подробная информация о списке элементов  
[iPhone IMEI Checker](https://www.imeipro.info/check_imei_iphone.html)  - Получите информацию о #iPhone от International Mobile Equipment Identity  
[LEI search](https://search.gleif.org/#/search/)  - может помочь найти "кому принадлежит" или "кому принадлежит"  
[Panjiva.com](https://panjiva.com/)  - данные поиска по миллионам отправлений по всему миру  
[en.52wmb.com](https://en.52wmb.com)  - Поиск информации о покупателях и поставщиках по всему миру по названию продукта, названию компании или коду ТН ВЭД.
[Reelgood.com](https://reelgood.com/)  - поисковая система для более чем 300 бесплатных и платных потоковых сервисов (Netflix, Amazon Prime Video, HBO, BBC, DisneyPlus)  
[IMCDB](http://imcdb.org)  - База данных автомобилей в Интернете  
[Subzin.com](http://www.subzin.com/)  - по одной фразе найдете фильм, а так же полный текст диалога с хронометражем  
[Unogs.com](http://unogs.com/)  - Поиск Нетфликс без регистрации  
[flixable.com](http://flixable.com )  - альтернативный способ найти что-нибудь интересное на Netflix  
[flixwatch.co](http://flixwatch.co )  - альтернативный способ найти что-нибудь интересное на Netflix  
[flicksurfer.com](http://flicksurfer.com )  - альтернативный способ найти что-нибудь интересное на Netflix  
[flixboss.com](http://flixboss.com)  - альтернативный способ найти что-нибудь интересное на Netflix  
[flickmetrix.com](http://flickmetrix.com )  - альтернативный способ найти что-нибудь интересное на Netflix  
[whatthehellshouldiwatchonnetflix.com](http://whatthehellshouldiwatchonnetflix.com )  - альтернативный способ найти что-нибудь интересное на Netflix  
[netflix-codes.com](http://netflix-codes.com)  - альтернативный способ найти что-нибудь интересное на Netflix
[Radion.net](https://www.radio.net/local-stations)  - просматривать список всех радиостанций рядом с вами и искать радиостанции по ключевым словам  
[American Archive of Public Broadcasting](https://americanarchive.org)  - Откройте для себя исторические программы государственного радио и телевидения по всей Америке. Смотрите и слушайте
[AttifyOS](https://github.com/adi0x90/attifyos)  - Дистрибутив Linux для пентестинга устройств IoT.
